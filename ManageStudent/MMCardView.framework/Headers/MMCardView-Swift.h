...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MMCardView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10MMCardView8CardCell")
...
@interface CardCell (SWIFT_EXTENSION(MMCardView)) <UIGestureRecognizerDelegate>
...
SWIFT_CLASS("_TtC10MMCardView16CustomCardLayout")
@interface CustomCardLayout : UICollectionViewLayout
@property (nonatomic, copy) NSIndexPath * _Nullable selectPath;
...
SWIFT_CLASS("_TtC10MMCardView20CustomFlipTransition")
...
SWIFT_CLASS("_TtC10MMCardView16MMCollectionView")
...
@interface MMCollectionView (SWIFT_EXTENSION(MMCardView)) <UIViewControllerTransitioningDelegate>
- (id <UIViewControllerAnimatedTransitioning> _Nullable)animationControllerForPresentedController:(UIViewController * _Nonnull)presented presentingController:(UIViewController * _Nonnull)presenting sourceController:(UIViewController * _Nonnull)source SWIFT_WARN_UNUSED_RESULT;
- (id <UIViewControllerAnimatedTransitioning> _Nullable)animationControllerForDismissedController:(UIViewController * _Nonnull)dismissed SWIFT_WARN_UNUSED_RESULT;
@end


@interface MMCollectionView (SWIFT_EXTENSION(MMCardView)) <UICollectionViewDelegate>
